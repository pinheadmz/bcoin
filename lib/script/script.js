...
console.log('state / negate: ', state, negate,  '\n');
console.log(op.toSymbol());
...
console.log('validatesig: ', validateSignature(sig, flags));

console.log('validatekey: ', validateKey(key, flags, version));
