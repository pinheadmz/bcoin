...
class Program {
  ...
  getType() {
    ...
    if (this.version === 1) {
      ...
      // From BIP-Taproot: "Any other outputs, including version 1
      // outputs with lengths other than 32 bytes... remain unencumbered."
      // However, due to the malleability issue with bech32 addresses,
      // this rule may change before activation.
    }
