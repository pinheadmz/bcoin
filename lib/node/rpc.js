...
class RPC extends RPCBase {
  ...
  async help(args, _help) {
    if (args.length === 0) {
      let helpGuide = '';
      helpGuide += 'RPC commands:\n';
      helpGuide += '\n';
      helpGuide += '  -- Control --\n';
      helpGuide += '  $ stop: Stop the running node.\n';
      helpGuide += '  $ help: See this list.\n';
      helpGuide += '  $ getmemoryinfo: Returns memory usage info.\n';
      helpGuide += '  $ setloglevel [level]: '+
        'Change log level of running node.\n';
      helpGuide += '\n';
      helpGuide += '  -- Blockchain --\n';
      helpGuide += '  $ getblockchaininfo: Get blockchain information.\n';
      helpGuide += '  $ getbestblockhash: Get blockchain tip block hash.\n';
      helpGuide += '  $ getblockcount: Get number of blocks in chain.\n';
      helpGuide += '  $ getblock [hash]: Get information about block.\n';
      helpGuide += '  $ getblockbyheight [height]: '+
        'Get information about block.\n';
      helpGuide += '  $ getblockhash [height]: '+
        'Get block hash at given height.\n';
      helpGuide += '  $ getblockheader [hash]: Get block header given hash.\n';
      helpGuide += '  $ getchaintips: Get chain tips.\n';
      helpGuide += '  $ getdifficulty: '+
        'Get current proof-of-work difficulty target.\n';
      helpGuide += '  $ getmempoolancestors [txid]: '+
        'Get in-mempool ancestors for a transaction.\n';
      helpGuide += '  $ getmempooldescendants [txid]: '+
        'Get in-mempool descendandants for a transaction.\n';
      helpGuide += '  $ getmempoolentry [txid]: Get mempool transaction.\n';
      helpGuide += '  $ getmempoolinfo: Get information about mempool.\n';
      helpGuide += '  $ getrawmempool: Get mempool tx list.\n';
      helpGuide += '  $ gettxout [txid, index]: '+
        'Get outpoint of a transaction.\n';
      helpGuide += '  $ gettxoutproof [txid, hash]: '+
        'Get MerkleBlock proof of transaction inclusion in block. \n';
      helpGuide += '  $ gettxoutsetinfo: Get information about UTXO set.\n';
      helpGuide += '  $ pruneblockchain: Prunes blockchain.\n';
      helpGuide += '  $ verifychain: Verify blockchain database.\n';
      helpGuide += '  $ verifytxoutproof [proof]: '+
        'Check proof of transaction inclusion.\n';
      helpGuide += '  $ invalidateblock [hash]: '+
        'Invalidates block in the chain.\n';
      helpGuide += '  $ reconsiderblock [hash]: '+
        'Remove block from invalid list.\n';
      helpGuide += '\n';
      helpGuide += '  -- Mining --\n';
      helpGuide += '  $ getnetworkhashps [nBlocks, height]: '+
        'Get estimated hash rate.\n';
      helpGuide += '  $ getmininginfo: Get mining info.\n';
      helpGuide += '  $ prioritisetransaction [txid, priority, fee]: '+
        'Prioritise transaciton.\n';
      helpGuide += '  $ getwork [data]: '+
        'Get hashing work to be solved by miner.\n';
      helpGuide += '  $ getworklp: Long polling for new work.\n';
      helpGuide += '  $ getblocktemplate [JSON]: '+
        'Get block template for mining.\n';
      helpGuide += '  $ submitblock [block]: Add block to chain.\n';
      helpGuide += '  $ verifyblock [block]: Verify block data.\n';
      helpGuide += '  $ setgenerate [start/stop]: Start/stop mining on CPU.\n';
      helpGuide += '  $ getgenerate: Get mining status.\n';
      helpGuide += '\n';
      helpGuide += '  -- Generating --\n';
      helpGuide += '  $ generate [nBlocks]: Mine n blocks.\n';
      helpGuide += '  $ generatetoaddress [nBlocks, address]: '+
        'Mines blocks with address as coinbase.\n';
      helpGuide += '\n';
      helpGuide += '  -- Util --\n';
      helpGuide += '  $ getinfo: Reutrns general info.\n';
      helpGuide += '  $ estimatefee [nBlocks]: '+
        'Estimate fee to confirm in blocks.\n';
      helpGuide += '  $ estimatepriority [nBlocks]: '+
        'Estiamte priority (coin age) needed to confirm in blocks. \n';
      helpGuide += '  $ estimatesmartfee [nBlocks]: '+
        'Estimate smart fee to confirm in blocks.\n';
      helpGuide += '  $ estimatesmartpriority [nBlocks]: '+
        'Estimate smart priority needed to confirm in blocks.\n';
      helpGuide += '  $ validateaddress [address]: '+
        'Validate address for current network.\n';
      helpGuide += '  $ createmultisig [n, keyArray]: '+
        'Create a multisig address.\n';
      helpGuide += '  $ createwitnessaddress [script]: '+
        'Create witness address.\n';
      helpGuide += '  $ verifymessage [address, signature, message]: '+
        'Verify signature.\n';
      helpGuide += '  $ signmessagewithprivkey [privKey, message]: '+
        'Sign message with private key.\n';
      helpGuide += '  $ getmemoryinfo: Returns memory usage info.\n';
      helpGuide += '\n';
      helpGuide += '  -- Network --\n';
      helpGuide += '  $ setmocktime [timestamp]: Changes network time.\n';
      helpGuide += '  $ getconnectioncount: Get connection count.\n';
      helpGuide += '  $ ping: Ping every connected peer.\n';
      helpGuide += '  $ getpeerinfo: '+
        'Get information about all connected peers.\n';
      helpGuide += '  $ addnode [address] add: Add peer to host list.\n';
      helpGuide += '  $ addnode [address] onetry: '+
        'Attempt to connect to node.\n';
      helpGuide += '  $ addnode [address] remove: '+
        'Remove peer from host list.\n';
      helpGuide += '  $ disconnectnode [address]: Disconnect from node.\n';
      helpGuide += '  $ getaddednodeinfo [address]: '+
        'Get node information from host list.\n';
      helpGuide += '  $ getnettotals: '+
        'Get information about network resources.\n';
      helpGuide += '  $ getnetworkinfo: Get information about the network.\n';
      helpGuide += '  $ setban [address] add: Add node to ban list.\n';
      helpGuide += '  $ setban [address] remove: Remove node from ban list.\n';
      helpGuide += '  $ listbanned: List all banned peers.\n';
      helpGuide += '  $ clearbanned: Remove all banned peers.\n';
      helpGuide += '\n';
      helpGuide += '  -- Transactions --\n';
      helpGuide += '  $ getrawtransaction [txid]: Get raw transaction.\n';
      helpGuide += '  $ createrawtransaction [<many>]: '+
        'Create raw unsigned transaction.\n';
      helpGuide += '  $ decoderawtransaction [rawTX]: '+
        'Decode raw hex transaction.\n';
      helpGuide += '  $ decodescript [script]: Decode script.\n';
      helpGuide += '  $ sendrawtransaction [rawTX]: '+
        'Sends raw hex transaction without verifying.\n';
      helpGuide += '  $ signrawtransaction [<many>]: Sign raw transaction.\n';
      return helpGuide;
    }
