...
class RPC extends RPCBase {
  ...
  async help(args, _help) {
    if (args.length === 0) {
      ...
      helpGuide += '\n';
      helpGuide += '  $ help: Get this list.\n';
      helpGuide += '  $ stop: Close the wallet database.\n';
      helpGuide += '  $ fundrawtransaction [rawTX]: '+
        'Add inputs to tx until it exceeds output value.\n';
      helpGuide += '  $ resendwallettransactions: '+
        'Re-broadcast all unconfirmed transactions.\n';
      helpGuide += '  $ abandontransaction [txid]: '+
        'Remove transaction from database.\n';
      helpGuide += '  $ addmultisigaddress: (Not implemented)\n';
      helpGuide += '  $ addwitnessaddress: (Not implemented)\n';
      helpGuide += '  $ backupwallet [path]: '+
        'Back up wallet database to file.\n';
      helpGuide += '  $ dumpprivkey [address]: Get private key for address.\n';
      helpGuide += '  $ dumpwallet [path]: '+
        'Create readable wallet file with all private keys.\n';
      helpGuide += '  $ encryptwallet [passphrase]: '+
        'Encrypt wallet with passphrase.\n';
      helpGuide += '  $ getaccountaddress [account]: '+
        'Get current address for account.\n';
      helpGuide += '  $ getaccount [address]: '+
        'Get account associated with address.\n';
      helpGuide += '  $ getaddressesbyaccount [account]: '+
        'Get all addresses for account.\n';
      helpGuide += '  $ getbalance [accouunt]: '+
        'Get total balance for account.\n';
      helpGuide += '  $ getnewaddress [account]: '+
        'Get next receiving address for account.\n';
      helpGuide += '  $ getrawchangeaddress [account]: '+
        'Get next change address for account.\n';
      helpGuide += '  $ getreceivedbyaccount [account]: '+
        'Get total balance of account.\n';
      helpGuide += '  $ getreceivedbyaddress [address]: '+
        'Get total balance of address.\n';
      helpGuide += '  $ gettransaction [txid]: '+
        'Get information about wallet transaction.\n';
      helpGuide += '  $ getunconfirmedbalance: '+
        'Get wallet unconfirmed balance.\n';
      helpGuide += '  $ getwalletinfo: Get general information about wallet.\n';
      helpGuide += '  $ importprivkey [key]: Import private key.\n';
      helpGuide += '  $ importwallet [path]: '+
        'Import wallet backup file at path.\n';
      helpGuide += '  $ importaddress [address]: I'+
        'mport address to watch-only wallet.\n';
      helpGuide += '  $ importprunedfunds [rawtx, txoutproof]: '+
        'Import funds into pruned wallet.\n';
      helpGuide += '  $ importpubkey [key]: '+
        'Import public key into watch-only wallet.\n';
      helpGuide += '  $ keypoolrefill: (Not implemented)\n';
      helpGuide += '  $ listaccounts: List all account names and balances.\n';
      helpGuide += '  $ listaddressgroupings: (Not implemented)\n';
      helpGuide += '  $ listlockunspent: List all locked outputs. \n';
      helpGuide += '  $ listreceivedbyaccount: '+
        'Get balances for all accounts in wallet.\n';
      helpGuide += '  $ listreceivedbyaddress: '+
        'Get balances for all addresses in wallet.\n';
      helpGuide += '  $ listsinceblock [height]: '+
        'Get all transactions since block height.\n';
      helpGuide += '  $ listtransactions: Get all recent transactions.\n';
      helpGuide += '  $ listunspent: Get all unsopent transaciton outputs.\n';
      helpGuide += '  $ lockunspent [lock/unlock]: '+
        'Lock or unlock specified wallet outputs.\n';
      helpGuide += '  $ move: (Not implemented)\n';
      helpGuide += '  $ sendfrom [<many>]: Send Bitcoin to an address.\n';
      helpGuide += '  $ sendmany [<many>]: '+
        'Send Bitcoin to multiple addresses.\n';
      helpGuide += '  $ sendtoaddress [address, amount]: '+
        'Send Bitcoin to an address.\n';
      helpGuide += '  $ setaccount: (Not implemented)\n';
      helpGuide += '  $ settxfee [rate]: Set fee rate in BTC/kB.\n';
      helpGuide += '  $ signmessage [address, message]: '+
        'Sign message with private key for address.\n';
      helpGuide += '  $ walletlock: '+
        'Locks wallet by removing decryption key from memory.\n';
      helpGuide += '  $ walletpassphrasechange [old, new]: '+
        'Change wallet encryption passphrase.\n';
      helpGuide += '  $ walletpassphrase [passphrase, nTime]: '+
        'Store wallet passphrase in memory for n seconds.\n';
      helpGuide += '  $ removeprunedfunds [txid]: '+
        'Delete transaction from wallet database.\n';
      helpGuide += '  $ selectwallet [id]: '+
        'Switch target of future RPC calls.\n';
      helpGuide += '  $ getmemoryinfo: Get information about memory usage.\n';
      helpGuide += '  $ setloglevel: Change log level of wallet server.\n';
      return helpGuide;
    }
